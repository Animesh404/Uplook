...
export default function OnboardingOne() {
  ...
  const statusBarHeight = Platform.OS === "android" ? StatusBar.currentHeight || 0 : 44 // iOS notch height
  ...
  return (
    <View className="flex-1 bg-[#F0FFFF]">
      {/* Header - now includes proper spacing for status bar/notch */}
      <View style={{ paddingTop: statusBarHeight, paddingHorizontal: 16 }}>
        <ProgressHeader step={1} totalSteps={3} onBack={() => router.back()} />
      </View>

      {/* Bottom sheet style container - starts immediately after header */}
      <View className="flex-1 bg-[#FFFFFF] rounded-t-3xl overflow-hidden shadow-lg">
