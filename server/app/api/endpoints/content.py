...
from app.db.models import Content, User, CategoryEnum, ContentTypeEnum
from app.db.schemas import Content as ContentSchema, ContentCreate
...
async def get_library_content(
    ...
    content_items = db.query(Content).filter(
        Content.content_type == ContentTypeEnum.LEARNING_MODULE
